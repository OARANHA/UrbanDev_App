...
const DashboardEnterprise = Loadable(lazy(() => import('@/views/dashboard/DashboardEnterprise')))
...
// enterprise pages
const OrganizationsPage = Loadable(lazy(() => import('@/views/enterprise/OrganizationsPage')))
const WorkspaceAnalyticsPage = Loadable(lazy(() => import('@/views/enterprise/WorkspaceAnalyticsPage')))
const AuditLogsPage = Loadable(lazy(() => import('@/views/enterprise/AuditLogsPage')))
...
const MainRoutes = {
    ...
    children: [
        ...
        },
        {
            path: '/organizations',
            element: (
                <RequireAuth permission={'organization:view'} display={'feat:organizations'}>
                    <OrganizationsPage />
                </RequireAuth>
            )
        },
        {
            ...
            element: (
                <RequireAuth permission={'workspace:analytics'} display={'feat:workspace-analytics'}>
        ...
        },
        {
            path: '/audit-logs',
            element: (
                <RequireAuth permission={'audit:view'} display={'feat:audit-logs'}>
                    <AuditLogsPage />
                </RequireAuth>
            )
        }
